...
(
  ...
  reg 	[31:0]	addr_q, wdata_q, pmp_encrypt_q;
  ...
  begin
      if (!rst_ni) begin
          ...
          // Handle normal operational assignments
          case (state)
              IDLE: begin
                  if (req_i) begin
                      pmp_encrypt_hold <= pmp_encrypt_i;
                  end
              end
              END: begin
                  if (req_i) begin
                      pmp_encrypt_hold <= 1'd0; 
                  end
              end
              default: begin
                  pmp_encrypt_hold <= pmp_encrypt_hold;
              end
          endcase
      end
  end
