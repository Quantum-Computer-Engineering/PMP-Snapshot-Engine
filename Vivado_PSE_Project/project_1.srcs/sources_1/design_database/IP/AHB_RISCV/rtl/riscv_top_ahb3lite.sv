...
module riscv_top_ahb3lite #(
					...
					parameter PMP_NUM_REGIONS     = 32,
					
					parameter PMP_ENCRYPTION_ENABLED = 0
 )
(
				// BRAM INSTRUCTION INTERFACE
        ...
        // BRAM/AHB DATA INTERFACE
          output wire			    lsu_req_o,
          input  wire			    lsu_gnt_i,
          input  wire			    lsu_rvalid_i,
          output wire	[31:0]	lsu_addr_o,
          output wire         lsu_we,
          output wire [3:0]		lsu_be,
