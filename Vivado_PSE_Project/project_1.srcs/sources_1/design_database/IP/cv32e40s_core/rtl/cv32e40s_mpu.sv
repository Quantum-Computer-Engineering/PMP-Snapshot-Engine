...
//  - Use special parameter for PMP to activate it wihtout activating all
//    Xsecure features: PMP = USE_PMP;
//  - Used assign pmp_priv_lvl = privlvl_t'(convert_to_privlvl_t(core_trans_i.prot[2:1]));
//    otherwise Vivado gives errors.
