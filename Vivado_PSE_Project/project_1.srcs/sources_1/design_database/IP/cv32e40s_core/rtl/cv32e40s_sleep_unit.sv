...
//  - Commented out the core_clock_gate_i because the use of the sim_clock_gate 
//    results in a critical timing warning because a LUT is in the clk tree.
...
// CL: the use of the sim_clock_gate results in a critical timing warning because a LUT is in the clk tree
